...
export const DISPOSITIVOS_DEFAULT: DispositivoExtra[] = [
  {
    ...
    nombre: 'Shock Sensor',
    nivel: 'alto',
    cantidades: [1,2,3,4,6,12],
    precios:    [59999, 79999, 99999, 129999, 189999, 379998],
    cuotas:     [5999,  11998, 17997, 23996,  35994,  71988],
    comisiones: [20000, 30000, 40000, 50000,  70000,  140000],
  },
  {
    id: 'shock_bajo',
    nombre: 'Shock Sensor',
    nivel: 'bajo',
    cantidades: [1,2,3,4,6,12],
    precios:    [39999, 59999, 79999, 99999, 149999, 299998],
    cuotas:     [5999,  11998, 17997, 23996, 35994,  71988],
    comisiones: [8000,  12000, 16000, 20000, 28000,  56000],
  },
  {
    id: 'orion_alto',
    nombre: 'Orion',
